...
#' @param countyGeogField Name of field (column) in \code{geogCounty} with county names.
...
#' @param stateGeogAreaField Name of field (column) in \code{geogState} with state area in km2. If \code{NULL} then this will be calculated.
#' @param countyGeogAreaField Name of field (column) in \code{geogCounty} with county area in km2. If \code{NULL} then this will be calculated.
...
darwinCoreSpatialAssign <- function(
	...
	stateGeogAreaField = NULL,
	countyGeogAreaField = NULL,
	verbose = TRUE,
	...
) {
	...
	######################
		...
		if (verbose) omnibus::say('Matching data frame to GADM geometry...')
	...
	###################################################
		...
		stateOfDarwin <- stringi::stri_trans_general(stateOfDarwin, 'latin-ascii')
		stateCountyOfDarwin <- stringi::stri_trans_general(stateCountyOfDarwin, 'latin-ascii')
		
		## names in geography
		stateOfGeog <- tolower(unique(geogState@data[ , stateGeogField]))
		countyOfGeog <- tolower(geogCounty@data[ , countyGeogField])
		stateCountyOfGeog <- tolower(unique(paste(geogCounty@data[ , stateGeogField], geogCounty@data[ , countyGeogField])))
		stateOfGeogLower <- tolower(stateOfGeog)
		stateCountyOfGeogLower <- tolower(stateCountyOfGeog)
			
		stateOfGeog <- stringi::stri_trans_general(stateOfGeog, 'latin-ascii')
		countyOfGeog <- stringi::stri_trans_general(countyOfGeog, 'latin-ascii')
		stateCountyOfGeog <- stringi::stri_trans_general(stateCountyOfGeog, 'latin-ascii')
		stateOfGeogLower <- stringi::stri_trans_general(stateOfGeogLower, 'latin-ascii')
		stateCountyOfGeogLower <- stringi::stri_trans_general(stateCountyOfGeogLower, 'latin-ascii')

		# bad strings
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern=' county', replacement='')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern=' cty.', replacement='')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern=' cty', replacement='')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern=' city', replacement='')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern='city of ', replacement='')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern='st. ', replacement='saint ')
		stateCountyOfDarwin <- gsub(stateCountyOfDarwin, pattern='ste. ', replacement='saint ')
		
		countyOfGeog <- gsub(countyOfGeog, pattern=' county', replacement='')
		countyOfGeog <- gsub(countyOfGeog, pattern=' cty.', replacement='')
		countyOfGeog <- gsub(countyOfGeog, pattern=' cty', replacement='')
		countyOfGeog <- gsub(countyOfGeog, pattern=' city', replacement='')
		countyOfGeog <- gsub(countyOfGeog, pattern='city of ', replacement='')
		countyOfGeog <- gsub(countyOfGeog, pattern='st. ', replacement='saint ')
		countyOfGeog <- gsub(countyOfGeog, pattern='ste. ', replacement='saint ')
		
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern=' county', replacement='')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern=' cty.', replacement='')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern=' cty', replacement='')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern=' city', replacement='')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern='city of ', replacement='')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern='st. ', replacement='saint ')
		stateCountyOfGeog <- gsub(stateCountyOfGeog, pattern='ste. ', replacement='saint ')
		
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern=' county', replacement='')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern=' cty.', replacement='')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern=' cty', replacement='')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern=' city', replacement='')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern='city of ', replacement='')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern='st. ', replacement='saint ')
		stateCountyOfGeogLower <- gsub(stateCountyOfGeogLower, pattern='ste. ', replacement='saint ')
	...
	#####################
		...
		if (is.null(stateGeogAreaField)) {
			...
			stateArea_km2 <- geogState@data[ , stateGeogAreaField]
		}
		
		names(stateArea_km2) <- tolower(geogState@data[ , stateGeogField])
		
		if (is.null(countyGeogAreaField)) {
			...
			countyArea_km2 <- geogCounty@data[ , countyGeogAreaField]
		}
		
		names(countyArea_km2) <- tolower(paste(geogCounty@data[ , stateGeogField], geogCounty@data[ , countyGeogField]))
		gc()
	...
	#########################################################################
		...
		if (length(recs) > 0) {
			...
			stateCountyExtractFromGeog <- terra::extract(geogCounty, these[ , ll])
...
.subCoordPrecision <- function(
	...
	rm(geogCountry, geogState, geogCounty)
	gc()
